...
class ArchitectureIntegrationTest {
    ...
    fun testMetalBackendRegistration() {
        ...
        // Metal backend should not be in the list since it's not available on this platform
        assertFalse(availableBackends.contains("metal"))
        
        // But we should have the mega backend
