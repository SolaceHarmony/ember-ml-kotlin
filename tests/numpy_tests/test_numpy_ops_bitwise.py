"""
Pytest functions for frontend bitwise operations with NumPy backend active.
...
def test_bitwise_and(numpy_backend):
    """Test bitwise.bitwise_and with NumPy backend."""
...
def test_bitwise_or(numpy_backend):
    """Test bitwise.bitwise_or with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
    b = tensor.convert_to_tensor(data_b_uint16, dtype='uint16')
...
def test_bitwise_xor(numpy_backend):
    """Test bitwise.bitwise_xor with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
    b = tensor.convert_to_tensor(data_b_uint16, dtype='uint16')
...
def test_bitwise_not(numpy_backend):
    """Test bitwise.bitwise_not with NumPy backend."""
...
def test_left_shift(numpy_backend):
    """Test bitwise.left_shift with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_right_shift(numpy_backend):
    """Test bitwise.right_shift with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
    shifts = tensor.convert_to_tensor([1, 2, 0, 4], dtype='int32')
...
def test_rotate_left(numpy_backend):
    """Test bitwise.rotate_left with NumPy backend."""
...
def test_rotate_right(numpy_backend):
    """Test bitwise.rotate_right with NumPy backend."""
    val_u8 = tensor.convert_to_tensor([0b11001010], dtype='uint8')
    shifts = tensor.convert_to_tensor([2], dtype='int32')
...
def test_count_ones(numpy_backend):
    """Test bitwise.count_ones with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_count_zeros(numpy_backend):
    """Test bitwise.count_zeros with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_get_bit(numpy_backend):
    """Test bitwise.get_bit with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_set_bit(numpy_backend):
    """Test bitwise.set_bit with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_toggle_bit(numpy_backend):
    """Test bitwise.toggle_bit with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_binary_wave_interference(numpy_backend):
    """Test bitwise.binary_wave_interference with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
    b = tensor.convert_to_tensor(data_b_uint16, dtype='uint16')
...
def test_binary_wave_propagate(numpy_backend):
    """Test bitwise.binary_wave_propagate with NumPy backend."""
    a = tensor.convert_to_tensor(data_a_uint16, dtype='uint16')
...
def test_create_duty_cycle(numpy_backend):
    """Test bitwise.create_duty_cycle with NumPy backend."""
    length = 8
...
def test_generate_blocky_sin(numpy_backend):
    """Test bitwise.generate_blocky_sin with NumPy backend."""
    length = 8
    half_period = 2
