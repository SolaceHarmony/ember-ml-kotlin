...
def test_rnn_forward_numpy(numpy_backend): # Use fixture
    """Tests RNN layer single step forward pass with NumPy backend."""
...
def test_lstm_forward_numpy(numpy_backend): # Use fixture
    """Tests LSTM layer single step forward pass with NumPy backend."""
    input_size, hidden_size, batch_size, _ = _get_rnn_params()
...
def test_gru_forward_numpy(numpy_backend): # Use fixture
    """Tests GRU layer single step forward pass with NumPy backend."""
    input_size, hidden_size, batch_size, _ = _get_rnn_params()
...
def test_enhanced_ncpmap_numpy(numpy_backend):
...
def test_fully_connected_ncpmap_numpy(numpy_backend):
...
def test_cfc_with_enhanced_ncpmap_numpy(numpy_backend):
...
def test_ltc_with_enhanced_ncpmap_numpy(numpy_backend):
...
def test_ltc_with_fully_connected_ncpmap_numpy(numpy_backend):
