...
@pytest.fixture
def se_cfc_setup(torch_backend):
...
def test_initialization(se_cfc_setup, torch_backend):
...
def test_build(se_cfc_setup, torch_backend):
...
def test_forward_pass(se_cfc_setup, torch_backend):
...
def test_return_state(se_cfc_setup, torch_backend):
...
def test_go_backwards(se_cfc_setup, torch_backend):
...
def test_regularization_loss(se_cfc_setup, torch_backend):
...
def test_reset_state(se_cfc_setup, torch_backend):
...
def test_get_config(se_cfc_setup, torch_backend):
...
def test_training(se_cfc_setup, torch_backend):
