...
# --- Helper Module ---
# Re-defined here for clarity, though could be imported if placed in a common test util
...
def test_module_parameter_registration_torch(torch_backend): # Use fixture
    """Tests parameter registration with PyTorch backend."""
...
def test_parameter_properties_torch(torch_backend): # Use fixture
...
def test_dense_forward_shape_torch(torch_backend): # Use fixture
    """Tests Dense forward pass shape with PyTorch backend."""
    in_features = 5
    out_features = 3
...
def test_dense_parameters_torch(torch_backend): # Use fixture
    """Tests Dense parameters with PyTorch backend."""
    in_features = 5
    out_features = 3
    layer = modules.Dense(input_dim=in_features, units=out_features)
...
def test_dense_no_bias_torch(torch_backend): # Use fixture
    """Tests Dense without bias with PyTorch backend."""
...
def test_dense_activation_torch(torch_backend): # Use fixture
    """Tests Dense with activation with PyTorch backend."""
    in_features = 4
    out_features = 3
