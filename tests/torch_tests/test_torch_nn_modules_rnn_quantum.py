...
def test_lqnet_forward(test_data):
    """Test forward pass of LQNet with Torch backend."""
    # Create LQNet model
    lqnet = LQNet(
...
def test_lqnet_return_state(test_data):
    """Test LQNet with return_state=True with Torch backend."""
...
def test_lqnet_no_sequences(test_data):
    """Test LQNet with return_sequences=False with Torch backend."""
...
def test_ctrqnet_forward(test_data):
    """Test forward pass of CTRQNet with Torch backend."""
...
def test_ctrqnet_return_state(test_data):
    """Test CTRQNet with return_state=True with Torch backend."""
...
def test_ctrqnet_no_harmonic(test_data):
    """Test CTRQNet without harmonic embedding with Torch backend."""
