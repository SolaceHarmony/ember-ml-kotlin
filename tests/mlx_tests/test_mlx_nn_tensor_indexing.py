# tests/mlx_tests/test_nn_tensor_indexing.py
import pytest
...
def test_tensor_gather_mlx(mlx_backend): # Use fixture
    """Tests tensor.gather with MLX backend."""
...
def test_tensor_scatter_mlx(mlx_backend): # Use fixture
    """Tests tensor.scatter with MLX backend."""
...
def test_tensor_scatter_nd_update_mlx(mlx_backend): # Use fixture
    """Tests tensor.tensor_scatter_nd_update with MLX backend."""
...
def test_tensor_slice_mlx(mlx_backend): # Use fixture
    """Tests tensor.slice with MLX backend."""
    params = _get_indexing_tensor()
    sliced = tensor.slice_tensor(params, [1, 0], [2, 2])
...
def test_tensor_pad_mlx(mlx_backend): # Use fixture
    """Tests tensor.pad with MLX backend."""
